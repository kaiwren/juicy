        ...
        function($) {
          ...
          var Logging = {
            log: function(object) {
              ...
              if ($.isConsolePresent()) {
                ...
                console.log(timestamp + ' : '+ object.toString());
                console.log(object);
              }
              else {
                // Use this if you don't have a console. You need that div in place.
                $('#debug').append('<div class="entry">' + timestamp + ' | ' + '<pre>' + object + '</pre></div>');
              }
            },
          ...
          var JsCoreExtensions = {
            ...
            setupInheritanceChain: function(subClass, baseClass) {
              // Based partially on http://www.kevlindev.com/tutorials/javascript/inheritance/index.htm
